        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="hidden lg:block rounded-l-lg">
            <figure className="rounded-l-lg">
                <img src={signupImg} alt="" className="lg:mt-2 w-10/12 rounded-l-lg" />
            </figure>
          </div>

          {/* === Sign up form ===*/}
          <div className="rounded-l-lg lg:pl-16 ">
            <h2 className="text-headingColor text-[35px] leading-9 font-bold mb-10 text-center">
            ...
            <form onSubmit={submitHandler}>
               <div className="mb-5">
                 ...
                 text-[22px] leading-7 text-headingColor placeholder:text-textColor"
                 required/>
               </div>
               ...
               <div className="mb-5 flex items-center gap-10">
                 ...
                 leading-7 ">
                  Are you a:
                    ...
                    px-4 py-3 focus:outline-none cursor-pointer">
               ...
               <div className="mb-5 flex items-center gap-3">
                  ...
                  border-primaryColor flex items-center justify-center">
                      <img src={avatar} alt="" className="w-full rounded-full"></img>
                  </figure>
          ...
          <p className="mt-5 text-textColor text-center">
             Already have an account? <Link to='/login' className="text-primaryColor font-medium
             ml-1" >Login</Link>
          </p>
            </form>
          </div>
