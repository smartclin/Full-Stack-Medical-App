...
const MyAccount = () => {
  ...
  const { data: userData, loading } = useGetProfile(`${BASE_URL}/users/profile/me`);
  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 mx-auto">
        {/*El codigo de abajo da error fijarse si no funciona*/}
        {!loading && (
          <div className="grid md:grid-cols-3 gap-10">
            <div className="pb-[50px] px-[30px] rounded-md">
              <div className="flex items-center justify-center">
                <figure className="w-[100px] h-[100px] mt-10 rounded-full border-2 border-solid border-primaryColor">
              ...
              <div className="text-center mt-4">
                ...
                <p className="text-textColor text-[15px] leading-6 font-medium">Muhibur Rahman@gmail.com</p>
            ...
            <div className="md:col-span-2 md:px-[30px]">
              <div>
                ...
                <button
                  ...
                  } py-2 ml-5 px-5 rounded-md text-headingColor font-semibold text-[16px]
                     leading-7 border border-solid border-primaryColor`}
                >
                  My bookings
                </button>
